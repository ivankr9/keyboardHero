...
while run:
    for event in pg.event.get():
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_PERIOD:    #K_PERIOD
            play_bass_note(25, bass_sounds, bass_to_activate_list) # hi D#

        
        #if event.type == pg.KEYDOWN and event.key == pg.K_SLASH:    #K_PERIOD
        #    play_bass_note(28, bass_sounds, bass_to_activate_list) # hi f# 
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_w: # d
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_e: # e
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_r: # f
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_t: # g
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_y: # a
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_u: # b
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_i: # hi c
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_o: # hi d
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_p: # hi E
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_LEFTBRACKET: # F
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_3: # d#
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_6: # G#
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_7: # A#
        ...
        if event.type == pg.KEYDOWN and event.key == pg.K_0: # d#
